  ...
  return (
    <div className="p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-white tracking-wider">OPERATIONS CENTER</h1>
          <p className="text-xs sm:text-sm text-neutral-400">Mission planning and execution oversight</p>
        </div>
        <div className="flex gap-2 w-full sm:w-auto">
          <Button className="bg-orange-500 hover:bg-orange-600 text-white flex-1 sm:flex-none text-xs sm:text-sm">
            New Operation
          </Button>
          <Button className="bg-orange-500 hover:bg-orange-600 text-white flex-1 sm:flex-none text-xs sm:text-sm">
            Mission Brief
          ...
          <CardContent className="p-3 sm:p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg sm:text-2xl font-bold text-white font-mono">23</p>
              </div>
          ...
          <CardContent className="p-3 sm:p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg sm:text-2xl font-bold text-white font-mono">156</p>
              </div>
          ...
          <CardContent className="p-3 sm:p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg sm:text-2xl font-bold text-red-500 font-mono">2</p>
              </div>
          ...
          <CardContent className="p-3 sm:p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg sm:text-2xl font-bold text-white font-mono">94%</p>
              </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2 text-xs text-neutral-400">
                  ...
                  <span className="hidden sm:inline">Est. completion: {operation.estimatedCompletion}</span>
                  <span className="sm:hidden">Est: {operation.estimatedCompletion}</span>
                </div>
              </div>
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-3 sm:p-4 z-50">
          <Card className="bg-neutral-900 border-neutral-700 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                <CardTitle className="text-lg sm:text-xl font-bold text-white tracking-wider">
            ...
            <CardContent className="space-y-4 sm:space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-2 pt-4 border-t border-neutral-700">
                <Button className="bg-orange-500 hover:bg-orange-600 text-white flex-1 sm:flex-none">
                  Update Status
                </Button>
                <Button
                  variant="outline"
                  className="border-neutral-700 text-neutral-400 hover:bg-neutral-800 hover:text-neutral-300 bg-transparent flex-1 sm:flex-none"
                >
                  View Reports
                </Button>
                <Button
